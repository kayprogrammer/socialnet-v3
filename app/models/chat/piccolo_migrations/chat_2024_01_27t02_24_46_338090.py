...
class Chat(Table, tablename="chat", schema=None):
    id = UUID(
        default=UUID4(),
        null=False,
        primary_key=True,
...
async def forwards():
    ...
    manager.add_table(class_name="Chat", tablename="chat", schema=None, columns=None)
    ...
    manager.add_column(
        ...
        params={
            ...
            "index": False,
            "index_method": IndexMethod.btree,
            "choices": Enum("ChatChoices", {"DM": "DM", "GROUP": "GROUP"}),
            "db_column_name": None,
            "secret": False,
        },
        schema=None,
