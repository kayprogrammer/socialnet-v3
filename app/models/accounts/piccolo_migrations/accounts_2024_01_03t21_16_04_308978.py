...
async def forwards():
    ...
    manager.add_column(
        table_class_name="User",
        tablename="base_user",
        column_name="terms_agreement",
        db_column_name="terms_agreement",
    ...
    manager.add_column(
        ...
        db_column_name="is_email_verified",
        column_class_name="Boolean",
        column_class=Boolean,
        params={
            "default": False,
    ...
    manager.add_column(
        table_class_name="Jwt",
        tablename="jwt",
        column_name="refresh",
        db_column_name="refresh",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 1000,
